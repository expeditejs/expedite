  ...
  const answers = await inquirer.prompt([
    {
      type: 'input',
      message:
        'Enter new project name (ex: ExpediteJS Core) [Use empty value to skip]:',
...
function endProcess() {
  process.stdout.write(
    boxen(
      `
Thank you for using ExpediteJS Core !

Do not hesitate to file an issue if you need help!

You can also contact us on twitter or instagram
${chalk.blue('@thewhitewulfy')}.
